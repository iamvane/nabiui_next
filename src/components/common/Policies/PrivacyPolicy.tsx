  ...
  return (
    <div className="nabi-container">
      <div className="nabi-section nabi-background-white nabi-margin-bottom-medium">
        ...
        <Typography variant="h2">I. Information We Collect and How It Is Used</Typography>
        ...
        <h5>B. Types Of Information We Collect</h5>
        ...
        <h5>C. Use of Registration and Visitor Information</h5>
        ...
        <h5>D. Email Marketing From Third Party Sponsors</h5>
        ...
        <h5>E. Voluntary Customer Surveys</h5>
        ...
        <h5>F. "Cookies" and How We Use Them</h5>
        ...
        <h5>G. Additional Technologies</h5>
        ...
        <h5>H. In the Event of a Change in Ownership</h5>
        ...
        <ul>
          ...
          <br />
          <li>
            f. We will not knowingly provide any direct link href websites that are unsuitable for children or teens.
          </li>
          <br />
          <li>
      ...
      <h5>L. Nabi Music Group Lessons</h5>
      When you attend live, group classes through Nabi Music, other people who subscribe to Nabi Music will be able to see your name, your image, your comments, your voice, and your profile. In addition, we may also broadcast Nabi Music Live classes to other sites such as the Nabi Music Blog, YouTube or Facebook. We may also record the video and audio components of those classes and rebroadcast them on our sites or other sites, or store them temporarily or permanently. In those instances, the general public may also be able to see your name, your image, your voice, and your comments (collectively referred to herein as the “Released Subject Matter”). 
      <h5>M. Sharing Information with Our Services</h5>
      Profile
      <br />
      <br />
      Your profile is fully visible to all Members, users and customers of our Services. It may also be visible to others on or off of our Services (e.g., users of third- party search engines). Excerpts from your profile may appear on the services of others (e.g., search engine results, mail and calendar applications that show a user a “mini” Nabi Music profile of the person they are meeting or messaging, social media aggregators). “Old” profile information may remain on these services until they update their data cache with changes you made to your profile. Your settings, the degree of connection or interests you have with the viewing Member, the subscriptions they may have, their usage, and other variables impact the availability of your profile and whether they can view certain fields in your profile.
      <br />
      <br />
      ...
      <Typography variant="h2">III. Communication to Members and Visitors</Typography>
      ...
      <h5>B. Responses to Email Inquiries</h5>
      ...
      <h5>C. Our Commitment to Data Security</h5>
      ...
      <Typography variant="h2">IV. Miscellaneous</Typography>
      <h5>A. Where to Direct Questions About Our Privacy Policy</h5>
      If you have any questions about this Privacy Policy or the practices described herein, you may contact:
      <br />
      <br />
      Attn: Nabi Music Center, LLC
      <br />
      1609 Clinton Avenue
      <br />
      South Plainfield, NJ 07080
      <h5>B. Changes to This Policy</h5>
      As we update and expand our services, we may make changes to this policy. You should check back for updates to this policy from time to time. If the changes result in less protection for your personal information than those provided in this policy, we will make reasonable efforts to contact you to let you know. You acknowledge that your assent to the Terms of Use (which includes this Privacy Policy) subsequent to any changes made following your initial consent will satisfy the foregoing obligation. Similarly, your use of the Nabi Music website or continued use of our Service after our posting of changes to this policy, or efforts to contact you, means that you agree to be bound by such changes. The most current version of this Privacy Policy can be reviewed by visiting our website and clicking on “Privacy Policy” located at the Nabi Music website. The most current version of the Privacy Policy will supersede all previous versions.
      <h5>C. Terms of Use, Arbitration and Governing Law</h5>
      If you choose to visit our Website or use our Services, your visit and any dispute over privacy is subject to this Privacy Policy and our <Link href={Routes.TermsOfUse}>Terms of Use</Link>, including limitations on damages, resolution of disputes through binding arbitration on an individual basis, and application of the law of the state of Massachusetts. If you have any concern about privacy at our Website or from our Services, please contact us with a thorough written description, and we will try to resolve it. Our business changes constantly, and our Privacy Policy and the <Link href={Routes.TermsOfUse}>Terms of Use</Link> will change also. We may e-mail periodic reminders of our notices, terms and conditions, but you should check our Website frequently to see recent changes. Unless stated otherwise, our current Privacy Policy applies to all information that we have about you and your account.
      <br />
