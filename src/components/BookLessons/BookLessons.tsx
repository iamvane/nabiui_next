    ...
    <div className="nabi-container nabi-margin-bottom-medium">
      ...
      {props.bookLessonsDataRequesting || props.chooseLessonPackageRequesting ? <div className="nabi-text-center"><CircularProgress /></div> :
        <div className="nabi-section nabi-background-white">
          {props.freeTrial ?
            <Typography>Enter payment method. You will not be charged. We will save your payment method so that you can use it later only if you want to purchase a lesson package.</Typography>
            :
            <React.Fragment>
          ...
          <Grid item={true} xs={12} md={6}>
            <StripeElementsWrapper>
              <StripePaymentForm submitPayment={submitPayment} isRequesting={props.bookLessonsRequesting} clientSecret={props.clientSecret} />
            </StripeElementsWrapper>
          </Grid>
        </div>
      }
