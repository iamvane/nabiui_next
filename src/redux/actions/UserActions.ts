...
import { getError } from '../../../utils/handleApiErrors';
import {
    requestAction,
    withDataAction,
    withErrorAction,
 ...
 */
export const createUser = (user: RegistrationType): ThunkAction<Promise<void>, {}, {}, any> => async (
 ...
 */
export const authenticateUser = (email: string, password: string): ThunkAction<Promise<void>, {}, {}, any> => async (
    dispatch: Dispatch<any>
) => {
...
export const fetchUserOnLogin = (token: string): ThunkAction<Promise<void>, {}, {}, any> => async (
    dispatch: Dispatch<any>
) => {
...
export const fetchUser = (): ThunkAction<Promise<void>, {}, {}, any> => async (
    dispatch: Dispatch<any>,
    getState
) => {
...
export const uploadAvatar = (value: string): ThunkAction<Promise<void>, {}, {}, any> => async (
    dispatch: Dispatch<any>,
    getState
) => {
    const state = getState();
 ...
 */
export const updateUser = (data: AccountInfoType): ThunkAction<Promise<void>, {}, {}, any> => async (
    dispatch: Dispatch<any>,
    getState
) => {
...
export const sendReferralInvite = (email: string): ThunkAction<Promise<void>, {}, {}, any> => async (
    dispatch: Dispatch<any>,
    getState
) => {
...
export const logOutUser = (): ThunkAction<Promise<void>, {}, {}, any> => async (
    dispatch: Dispatch<any>,
    getState
) => {
...
export const requestPasswordRecovery = (email: string): ThunkAction<Promise<void>, {}, {}, any> => async (
    dispatch: Dispatch<any>
) => {
...
export const setPassword = (password: string, token: string): ThunkAction<Promise<void>, {}, {}, any> => async (
    dispatch: Dispatch<any>
) => {
...
export const fetchLowestRate = (): ThunkAction<Promise<void>, {}, {}, any> => async (
    dispatch: Dispatch<any>
) => {
