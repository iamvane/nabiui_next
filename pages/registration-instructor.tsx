...
const RegistrationPage = (props: Props) => {
  return (
    <>
      <Head>
        <title>{pageTitlesAndDescriptions.registrationInstructor.title}</title>
        <meta name="description" content={pageTitlesAndDescriptions.registrationInstructor.description}></meta>
      </Head>
